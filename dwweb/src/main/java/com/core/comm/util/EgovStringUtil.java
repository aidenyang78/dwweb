...
public class EgovStringUtil {
	...
	/**
	 *<pre>
	 * 인자로 받은 String이 null일 경우 0.0을 리턴한다.
	 * &#064;param src null값일 가능성이 있는 String 값.
	 * &#064;return 만약 String이 null 값일 경우 0.0으로 바꾼 String 값.
	 *</pre>
	 */
	...
	public static BigDecimal bigConvert(String src) {
	...
	public static String[] split(String source, String delim) {
		...
		rltarr = new String[stoken.countTokens()];
		int count = 0;
		while (stoken.hasMoreTokens()) {
			rltarr[count] = stoken.nextToken().trim();
			count++;
		}
	 ...
	 * @return
	 */
	public static String getArrayToString(String[] array, String replace) {
		String rtn = "";
