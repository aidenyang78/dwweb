...
<!-- 설치 기본 -->										
										<tr>
											<th width="60px;"></th>
											<th class="center">
												<div class="h2_title_b">신호관리대장</div>
											</th>
											<th width="60px;"></th>
										</tr>
										<tr>
										<th width="60px;"></th>
											<th class="left">
												<div style="font-size:14px;">
													모순검지 <label for="detectOff">OFF</label><input type="radio" name="contradictionDetection" id="detectOff" value="0" <c:if test="${listInst.contradictionDetection eq 0 }">checked</c:if>/>
														<label for="detectOn">ON</label><input type="radio" name="contradictionDetection" id="detectOn" value="1" <c:if test="${listInst.contradictionDetection eq 1 }">checked</c:if>/>
													| 최종 수정 : ${listInst.updtDate} [ ${listInst.membNm}<c:if test="${!empty(listInst.delDate) }"> - 삭제된 관리자</c:if>]
												</div>
											</th>
											<th width="60px;"></th>
										</tr>
															...
															<td>
																<ul>
																	<li>
																		...
																		<input type="text" name="kindTrafficLight4" id="kindTrafficLight4" size="4" value="${listTf.kindTrafficLight4}" accesskey="NUM" class="hidden"/>
																	</li>
																</ul>
																<ul>
																	<li>
																		...
																		<input type="text" name="kindTrafficLight8" id="kindTrafficLight8" size="4" value="${listTf.kindTrafficLight8}" accesskey="NUM" class="hidden"/>
																	</li>
																</ul>
																...
																<ul>
																	<li>
																		...
																		<input type="text" name="kindTrafficLight12" id="kindTrafficLight12" size="4" value="${listTf.kindTrafficLight12}" accesskey="NUM" class="hidden"/>
																	</li>
																</ul>
																...
																<ul>
																	<li>
																		...
																		<input type="text" name="kindTrafficLight16" id="kindTrafficLight16" size="4" value="${listTf.kindTrafficLight16}" accesskey="NUM" class="hidden"/>
																	</li>
																</ul>
															</td>
...
<!-- 신호 제어기// -->
										...
										<tr>
											<th colspan="3">
												...
												<div>
													<label for="docStatus1" id="statusMsg1">등록 중</label><input type="radio" name="docStatus" id="docStatus1" value="1" <c:if test="${listInst.docStatus eq 1}">checked</c:if>/>
													&nbsp;<label for="docStatus0" id="statusMsg0">등록 완료</label><input type="radio" name="docStatus" id="docStatus0" value="0" <c:if test="${listInst.docStatus eq 0}">checked</c:if>/>
												</div>
											</th>
										</tr>
										<tr>
