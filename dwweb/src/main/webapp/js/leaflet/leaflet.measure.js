L.Control.Measure = L.Control.extend({
  ...
  onAdd: function (map) {
    ...
    this._createButton('&#8674;', '거리측정','leaflet-control-measure leaflet-bar-part leaflet-bar-part-top-and-bottom',container, this._toggleMeasure, this)
